# Contributing to Krabby Chat WebSocket Server
...
This section guides you through submitting an enhancement suggestion for Krabby Chat WebSocket Server, including completely new features and minor improvements to existing functionality. Following these steps helps maintainers and the community understand your suggestion and find related suggestions.
...
- **Explain why this enhancement would be useful** to most Krabby Chat WebSocket Server users. You may also want to point out the other projects that solved it better and which could serve as inspiration.
